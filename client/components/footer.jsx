  ...
  return (
    <footer className="bg-gray-800 pt-10 sm:mt-10 pt-10">
      ...
      <div className="pt-2">
        ...
        >
          <div className="mt-2">© Copyright 2022-year. All Rights Reserved.</div>

          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <a href="#" className="w-6 mx-1">
              <i className="uil uil-facebook-f">1</i>
            </a>
            <a href="#" className="w-6 mx-1">
              <i className="uil uil-twitter-alt">2</i>
            </a>
            <a href="#" className="w-6 mx-1">
              <i className="uil uil-youtube">3</i>
            </a>
            <a href="#" className="w-6 mx-1">
              <i className="uil uil-linkedin">4</i>
            </a>
            <a href="#" className="w-6 mx-1">
              <i className="uil uil-instagram">5</i>
            </a>
          </div>
        </div>
      </div>
